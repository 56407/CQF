...
cointO.reg = lm(curve2.this$X25 ~ curve2.this$X10) # estimating ECM the Other way requires recalculation of eq-correction term
eq_corrO.lag = lag(residuals(cointO.reg), k = -1)

...
%    \captionsetup{labelformat=nolabel}  % removes figure labels
\renewcommand{\thefigure}{\Alph{figure}}  % sets figure labels to letters
...
closely related, having very similar trends.
    \begin{center}
    \adjustimage{max size={1.0\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_9_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{itemize}
    ...
    \begin{center}
    \adjustimage{max size={0.8\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_32_0.png}
    \end{center}
...
\end{itemize}
    \begin{center}
    \adjustimage{max size={0.8\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_34_1.png}
    \end{center}
...
\end{equation}
    ...
    \begin{center}
    \adjustimage{max size={1.0\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_37_0.png}
    \end{center}
...
\hline
\textbf{Series} & \textbf{ADF t-stat} & \textbf{5\% Crit. Val.} & \textbf{1\% Crit. Val.} & \textbf{p-value} & \textbf{\begin{tabular}[c]{@{}l@{}}Stationary\\     (95\% C.L.)\end{tabular}} & \textbf{Stable} \\ \hline
e\_t            & -2.2335             & -1.9421                 & -2.5746                 & 0.0245           & Yes                                                                           & Yes             \\ \hline
\end{tabular}
\end{table}
...
\begin{equation}
\begin{array}{ccc}
\Delta y_{t}  = & -0.0861 + & 0.6455 \Delta x_t -0.1623 e_{t-1} + \epsilon_t \qquad \mathrm{(with~constant~fit,~R^2=0.407)} \\
\Delta y_{t}  = & & 0.6596 \Delta x_t -0.1633 e_{t-1} + \epsilon_t
\qquad \mathrm{(no~constant~fit, ~R^2=0.422)}
\end{array}
\end{equation}
This represents the second-order adjustment to the price, which as we
see can be significant.

\begin{figure}[!ht] 
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_74_2.png}
    \end{center}
        \caption{} \label{figa}
\end{figure}
    { \hspace*{\fill} \\}
...
obtained, from which the following trading bounds can be defined:
...
OU entry/exit bounds marked.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_99_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
which could be different between \(\mu_e\) and \(\sigma_{eq}\) given their different time-scales. However, the impact on performance in the out-of-sample would have to be addressed given that this introduces additional parameters into the model, potentially causing model-overfitting.
    ...
    \begin{figure}[!ht] 
        \begin{center}
    \adjustimage{max size={1.\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_104_1.png}
    ...
    \begin{center}
    \adjustimage{max size={1.\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_106_1.png}
    \end{center}
...
\bibitem{refp445} {\em Modeling Financial Time Series with S-PLUS - Chapter 12 - Cointegration} by Zivot, E. and Wang J. (2006)

\bibitem{cqfnotes} CQF lectures on {\em Cointegration and Statistical Arbitrage}, Diamond, R. (2016)
\bibitem{magazine}  {\em Learning and Trusting Cointegration in Statistical Arbitrage}, Diamond, R., Wilmott Magazine (2013)

 \bibitem{repo} {\em Personal Github repository}   \href{https://github.com/tsando/CQF/tree/master/finalProject}{https://github.com/tsando/CQF/tree/master/finalProject}
...
\bibitem{quantopian} \href{https://www.quantopian.com/lectures}{Quantopian Lectures - quantopian.com/lectures}

\bibitem{pyfolio} \href{https://github.com/quantopian/pyfolio/blob/master/pyfolio}{https://github.com/quantopian/pyfolio/blob/master/pyfolio}

\bibitem{ref} \href{https://en.wikipedia.org/wiki/Information\_criterion}{https://en.wikipedia.org/wiki/Information\_criterion}
\bibitem{error} \href{https://en.wikipedia.org/wiki/Propagation\_of\_uncertainty\#Simplification}{https://en.wikipedia.org/wiki/Propagation\_of\_uncertainty\#Simplification}

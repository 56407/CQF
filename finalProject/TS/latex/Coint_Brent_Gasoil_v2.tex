...
\(\sigma_{eq}\)\tabularnewline
\midrule
\endhead
AR(1) & 49.1253 & 0.0141 & -0.1255 & 16.3957 & 1.6541\tabularnewline
AR(3) & 258.9327 & 0.0027 & -0.0529 & 20.0723 & 0.8820\tabularnewline
\bottomrule
\end{longtable}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c}{\PYZsh{} ======  FIT TO OU PROCESS  ======}
...
The figure below shows the out-of-sample z-score spread, as estimated by
Equation X with the OU entry/exit bounds marked.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}217}]:} \PY{c}{\PYZsh{} ========= IN\PYZhy{}SAMPLE P\PYZam{}l =========}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}217}]:}              e\_t\_hat  e\_t\_hat\_norm  pos       chg       pnl    pnl\_cum
          Date                                                                  
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}219}]:} \PY{c}{\PYZsh{} ========= OUT\PYZhy{}OF\PYZhy{}SAMPLE P\PYZam{}l =========}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}219}]:}              e\_t\_hat  e\_t\_hat\_norm  pos       chg       pnl    pnl\_cum
          Date                                                                  
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}220}]:} \PY{c}{\PYZsh{} ======== PLOT OUT\PYZhy{}OF\PYZhy{}SAMPLE Z\PYZhy{}SCORE ========}
          ...
          \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{z\PYZhy{}score}\PY{l+s}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}220}]:} <matplotlib.text.Text at 0x1808a5c0>
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_92_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}256}]:} \PY{c}{\PYZsh{} ====== PLOT THE P\PYZam{}L CURVE FOR IN\PYZhy{}SAMPLE AND OUT\PYZhy{}OF\PYZhy{}SAMPLE ======}
          
          \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,} \PY{l+m+mi}{7}\PY{p}{)}\PY{p}{)}
          ...
          \PY{n}{plot\PYZus{}drawdown\PYZus{}periods}\PY{p}{(}\PY{n}{df\PYZus{}pnl\PYZus{}os}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{pnl}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{n}{k}\PY{p}{,} \PY{n}{top}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{r}\PY{l+s}{\PYZsq{}}\PY{p}{)}
          
          \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{gasoil benchmark}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{brent benchmark}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{strategy in\PYZhy{}sample}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{strategy out\PYZhy{}of\PYZhy{}sample}\PY{l+s}{\PYZsq{}}\PY{p}{]}\PY{p}{,} 
                     \PY{n}{loc}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{upper left}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{large}\PY{l+s}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{axvline}\PY{p}{(}\PY{n}{df\PYZus{}temp}\PY{o}{.}\PY{n}{index}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{black}\PY{l+s}{\PYZsq{}}\PY{p}{,} \PY{n}{linestyle}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZhy{}\PYZhy{}}\PY{l+s}{\PYZsq{}}\PY{p}{)}
          ...
          \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{P\PYZam{}L and top 5 drawdown periods }\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{ (in\PYZhy{}sample and out\PYZhy{}of\PYZhy{}sample)}\PY{l+s}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}256}]:} <matplotlib.text.Text at 0x1f7c32b0>
\end{Verbatim}
        
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_95_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_105_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Coint_Brent_Gasoil_v2_files/Coint_Brent_Gasoil_v2_108_0.png}
    \end{center}
    { \hspace*{\fill} \\}
